...
public class UserTemp {
	...
	private List<ScheduleUser> userScheduleList;
	
	
	
	public List<ScheduleUser> getUserScheduleList() {
		return userScheduleList;
	}
	public void setUserScheduleList(List<ScheduleUser> userScheduleList) {
	...
	public UserTemp(String uId, String uName, String uSex, String uPhone, String corId, String uAddr, String uProvince,
			String uCity, String deptId,String uVeinNum,String uPhotoUrl,String ujobNum,List<VeinFinger> veinFingerList,
			List<Sign> signList,List<ScheduleUser> userScheduleList) {
		super();
		this.uId = uId;
		this.uName = uName;
		this.uSex = uSex;
